...
CREATE TABLE `Back_office` (
  `cinemas_setting` int NOT NULL,
  `seance_setting` int NOT NULL,
  `user_setting` int NOT NULL,
  PRIMARY KEY (`cinemas_setting`,`seance_setting`,`user_setting`),
  KEY `seance_setting` (`seance_setting`),
  KEY `user_setting` (`user_setting`),
  CONSTRAINT `back_office_ibfk_1` FOREIGN KEY (`cinemas_setting`) REFERENCES `Cinemas` (`id`),
  CONSTRAINT `back_office_ibfk_2` FOREIGN KEY (`seance_setting`) REFERENCES `Seances` (`id`),
  CONSTRAINT `back_office_ibfk_3` FOREIGN KEY (`user_setting`) REFERENCES `Users` (`id`)
...
CREATE TABLE `Seances` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(155) NOT NULL,
  `movie_playing` int DEFAULT NULL,
  `seance_room` int DEFAULT NULL,
  `tickets_reference` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `movie_playing` (`movie_playing`),
  KEY `seance_room` (`seance_room`),
  KEY `tickets_reference` (`tickets_reference`),
  CONSTRAINT `seances_ibfk_1` FOREIGN KEY (`movie_playing`) REFERENCES `Movies` (`id`),
  CONSTRAINT `seances_ibfk_2` FOREIGN KEY (`seance_room`) REFERENCES `Rooms` (`id`),
  CONSTRAINT `seances_ibfk_3` FOREIGN KEY (`tickets_reference`) REFERENCES `Tickets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Tickets` (
  ...
  `ticket_prices` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ticket_prices` (`ticket_prices`),
  CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`ticket_prices`) REFERENCES `Prices` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-16 21:14:29
